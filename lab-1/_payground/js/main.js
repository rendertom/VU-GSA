...
// const file = fs.readFileSync(path.join(__dirname, './Thrash_metal.wav'));
// const file = fs.readFileSync(path.join(__dirname, './Stereo_music.wav'));
// const file = fs.readFileSync(path.join(__dirname, './Multitone.wav'));
...
const dataSubChunk = A.coroutine(function* () {
  ...
  console.log("duration", samples / fmtData.sampleRate);
...
console.log(output)
console.log(output.result.dataSubChunk.channelData.length)
console.log(output.result.dataSubChunk.channelData[0].length)
// console.log(output.result.dataSubChunk.channelData[1].length)
console.log(output.result.dataSubChunk.channelData[0][999998])
console.log(output.result.dataSubChunk.channelData[0][999009])
console.log(output.result.dataSubChunk.channelData[0].slice(999999, 100))
